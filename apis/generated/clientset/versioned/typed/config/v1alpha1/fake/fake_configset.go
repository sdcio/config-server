...
var configsetsResource = schema.GroupVersionResource{Group: "config.sdcio.dev", Version: "v1alpha1", Resource: "configsets"}

var configsetsKind = schema.GroupVersionKind{Group: "config.sdcio.dev", Version: "v1alpha1", Kind: "ConfigSet"}
...
func (c *FakeConfigSets) UpdateStatus(ctx context.Context, configSet *v1alpha1.ConfigSet, opts v1.UpdateOptions) (*v1alpha1.ConfigSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(configsetsResource, "status", c.ns, configSet), &v1alpha1.ConfigSet{})
