...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*TargetRunningOptions)(nil), (*config.TargetRunningOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_TargetRunningOptions_To_config_TargetRunningOptions(a.(*TargetRunningOptions), b.(*config.TargetRunningOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.TargetRunningOptions)(nil), (*TargetRunningOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_TargetRunningOptions_To_v1alpha1_TargetRunningOptions(a.(*config.TargetRunningOptions), b.(*TargetRunningOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_TargetClearDeviation_To_config_TargetClearDeviation(in *TargetClearDeviation, out *config.TargetClearDeviation, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_TargetClearDeviationSpec_To_config_TargetClearDeviationSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_TargetClearDeviationStatus_To_config_TargetClearDeviationStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_TargetClearDeviation_To_v1alpha1_TargetClearDeviation(in *config.TargetClearDeviation, out *TargetClearDeviation, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_config_TargetClearDeviationSpec_To_v1alpha1_TargetClearDeviationSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_config_TargetClearDeviationStatus_To_v1alpha1_TargetClearDeviationStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_TargetRunningOptions_To_config_TargetRunningOptions(in *TargetRunningOptions, out *config.TargetRunningOptions, s conversion.Scope) error {
	out.Path = in.Path
	out.Format = in.Format
	return nil
}

// Convert_v1alpha1_TargetRunningOptions_To_config_TargetRunningOptions is an autogenerated conversion function.
func Convert_v1alpha1_TargetRunningOptions_To_config_TargetRunningOptions(in *TargetRunningOptions, out *config.TargetRunningOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_TargetRunningOptions_To_config_TargetRunningOptions(in, out, s)
}

func autoConvert_config_TargetRunningOptions_To_v1alpha1_TargetRunningOptions(in *config.TargetRunningOptions, out *TargetRunningOptions, s conversion.Scope) error {
	out.Path = in.Path
	out.Format = in.Format
	return nil
}

// Convert_config_TargetRunningOptions_To_v1alpha1_TargetRunningOptions is an autogenerated conversion function.
func Convert_config_TargetRunningOptions_To_v1alpha1_TargetRunningOptions(in *config.TargetRunningOptions, out *TargetRunningOptions, s conversion.Scope) error {
	return autoConvert_config_TargetRunningOptions_To_v1alpha1_TargetRunningOptions(in, out, s)
}
