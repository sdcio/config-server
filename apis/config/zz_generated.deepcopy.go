...
func (in *UnManagedConfigFilter) DeepCopy() *UnManagedConfigFilter {
	if in == nil {
		return nil
	}
	out := new(UnManagedConfigFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UnManagedConfigList) DeepCopyInto(out *UnManagedConfigList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]UnManagedConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
