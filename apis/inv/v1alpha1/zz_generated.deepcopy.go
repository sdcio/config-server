...
func (in *DiscoveryParameters) DeepCopyInto(out *DiscoveryParameters) {
	*out = *in
	...
	if in.TargetConnectionProfiles != nil {
		...
		*out = make([]TargetConnProfile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetConnProfile) DeepCopyInto(out *TargetConnProfile) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetConnProfile.
func (in *TargetConnProfile) DeepCopy() *TargetConnProfile {
	if in == nil {
		return nil
	}
	out := new(TargetConnProfile)
	in.DeepCopyInto(out)
	return out
}
