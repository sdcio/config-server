...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubscriptionSync) DeepCopyInto(out *SubscriptionSync) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubscriptionSync.
func (in *SubscriptionSync) DeepCopy() *SubscriptionSync {
	if in == nil {
		return nil
	}
	out := new(SubscriptionSync)
	in.DeepCopyInto(out)
	return out
}
