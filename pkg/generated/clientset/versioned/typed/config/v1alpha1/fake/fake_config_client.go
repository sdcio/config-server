...
import (
	v1alpha1 "github.com/sdcio/config-server/pkg/generated/clientset/versioned/typed/config/v1alpha1"
...
func (c *FakeConfigV1alpha1) Targets(namespace string) v1alpha1.TargetInterface {
