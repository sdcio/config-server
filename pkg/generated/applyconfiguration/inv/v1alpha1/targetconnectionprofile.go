...
// TargetConnectionProfileApplyConfiguration represents a declarative configuration of the TargetConnectionProfile type for use
// with apply.
//
...
// TargetConnectionProfile constructs a declarative configuration of the TargetConnectionProfile type for use with
// apply.
func TargetConnectionProfile(name, namespace string) *TargetConnectionProfileApplyConfiguration {
	b := &TargetConnectionProfileApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("TargetConnectionProfile")
...
func (b *TargetConnectionProfileApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
