...
// TargetSyncProfileApplyConfiguration represents a declarative configuration of the TargetSyncProfile type for use
// with apply.
//
...
// TargetSyncProfile constructs a declarative configuration of the TargetSyncProfile type for use with
// apply.
func TargetSyncProfile(name, namespace string) *TargetSyncProfileApplyConfiguration {
	b := &TargetSyncProfileApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("TargetSyncProfile")
...
func (b *TargetSyncProfileApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
