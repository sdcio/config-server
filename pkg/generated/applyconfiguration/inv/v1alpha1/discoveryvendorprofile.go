...
// DiscoveryVendorProfileApplyConfiguration represents a declarative configuration of the DiscoveryVendorProfile type for use
// with apply.
//
...
// DiscoveryVendorProfile constructs a declarative configuration of the DiscoveryVendorProfile type for use with
// apply.
func DiscoveryVendorProfile(name, namespace string) *DiscoveryVendorProfileApplyConfiguration {
	b := &DiscoveryVendorProfileApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("DiscoveryVendorProfile")
...
func (b *DiscoveryVendorProfileApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
