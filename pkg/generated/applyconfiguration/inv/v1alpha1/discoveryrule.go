...
// DiscoveryRuleApplyConfiguration represents a declarative configuration of the DiscoveryRule type for use
// with apply.
//
...
// DiscoveryRule constructs a declarative configuration of the DiscoveryRule type for use with
// apply.
func DiscoveryRule(name, namespace string) *DiscoveryRuleApplyConfiguration {
	b := &DiscoveryRuleApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("DiscoveryRule")
...
func (b *DiscoveryRuleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
