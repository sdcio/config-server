...
func (b *ConfigSpecApplyConfiguration) WithLifecycle(value *LifecycleApplyConfiguration) *ConfigSpecApplyConfiguration {
	b.Lifecycle = value
	return b
}
...
func (b *ConfigSpecApplyConfiguration) WithPriority(value int64) *ConfigSpecApplyConfiguration {
	b.Priority = &value
	return b
}
...
func (b *ConfigSpecApplyConfiguration) WithRevertive(value bool) *ConfigSpecApplyConfiguration {
	b.Revertive = &value
	return b
}
...
func (b *ConfigSpecApplyConfiguration) WithConfig(values ...*ConfigBlobApplyConfiguration) *ConfigSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
