...
func NewStrategy(ctx context.Context, typer runtime.ObjectTyper, client client.Client, store storebackend.Storer[runtime.Object]) *strategy {
	...
	return &strategy{
		...
		resource:       &configv1alpha1.UnManagedConfig{},
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	api, ok := obj.(*configv1alpha1.UnManagedConfig)
	if !ok {
		return nil, nil, fmt.Errorf("given object is not a %s", configv1alpha1.UnManagedConfigKind)
	}
	return labels.Set(api.ObjectMeta.Labels), SelectableFields(api), nil
}

// SelectableFields returns a field set that represents the object.
func SelectableFields(obj *configv1alpha1.UnManagedConfig) fields.Set {
