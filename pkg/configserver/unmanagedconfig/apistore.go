...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config) (rest.Storage, error) {
	scheme.AddFieldLabelConversionFunc(
		schema.GroupVersionKind{
			...
			Kind:    configv1alpha1.UnManagedConfigKind,
		},
		configv1alpha1.ConvertUnManagedConfigFieldSelector,
	)
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &configv1alpha1.UnManagedConfig{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &configv1alpha1.UnManagedConfig{})
		if err != nil {
			return nil, err
		}
	default:
	...
	gr := configv1alpha1.Resource(configv1alpha1.UnManagedConfigPlural)
	strategy := NewStrategy(ctx, scheme, client, configStore)

	// This is the etcd store
	store := &registry.Store{
		Tracer:                    otel.Tracer("config-server"),
		NewFunc:                   func() runtime.Object { return &configv1alpha1.UnManagedConfig{} },
		NewListFunc:               func() runtime.Object { return &configv1alpha1.UnManagedConfigList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: configv1alpha1.Resource(configv1alpha1.UnManagedConfigSingular),
		...
		TableConvertor: NewTableConvertor(configv1alpha1.Resource(configv1alpha1.UnManagedConfigPlural)),
	}
