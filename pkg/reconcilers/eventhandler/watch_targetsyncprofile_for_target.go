...
type TargetSyncProfileForTargetEventHandler struct {
...
func (r *TargetSyncProfileForTargetEventHandler) add(ctx context.Context, obj runtime.Object, queue adder) {
